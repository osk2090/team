...
public class DiscountAddHandler extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    DiscountService DiscountServce =
    ...
    out.println("<html>");
    out.println("<head>");
    out.println("<title>Discount 등록</title>");

    try {
      // DiscountService.add(h);

      out.println("<meta http-equiv='Refresh' content='1;url=list'>");
      out.println("</head>");
      out.println("<body>");
      out.println("<h1>Discount 등록</h1>");
      out.println("<p>Discount 등록했습니다.</p>");
    } catch (Exception e) {
      ...
      out.println("</head>");
      out.println("<body>");
      out.println("<h1>Discount 등록 오류</h1>");
      out.printf("<pre>%s</pre>\n", strWriter.toString());
      out.println("<p><a href='list'>Discount 목록</a></p>");
    }
