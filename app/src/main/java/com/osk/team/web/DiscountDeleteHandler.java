...
public class DiscountDeleteHandler extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Discount 삭제</title>");
...
//            if (oldDiscount.getMno() != loginUser.getNo()) {
...
//            }
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Discount 삭제</h1>");
            out.println("<p>Discount를 삭제하였습니다.</p>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Discount 삭제 오류</h1>");
            out.printf("<p>%s</p>\n", e.getMessage());
